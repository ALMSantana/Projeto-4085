...
def avaliar_codigo():
    ...
    return Assistente(nome = nome_assistente, instrucoes = instrucoes_assistente, eh_ferramenta=False)
...
def pergunta_assistente_monitoramento(pergunta, caminho_script):
    ...
    while pergunta != "fim":
        ...
        print(f"\t::RESPOSTA::\n\n{resposta}")
        print(f"Avaliação da Resposta: {assistente.avaliar_resultado(resposta)}")
